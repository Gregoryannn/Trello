...
return (
    <div
        ref={drop}
        className={`w-72 max-h-full flex flex-col rounded ${isOver ? 'bg-gray-300' : 'bg-gray-200'
            }`}
    // style={{
                ...
                <div>
                    ...
                    <div className="flex items-center mt-2 space-x-2">
                        <button
                            ...
                            type="button"
                            className={`w-12 h-8 rounded flex text-sm text-white items-center justify-center font-semibold bg-blue-500 hover:bg-blue-600 shadow ${newCardTitle === '' && 'cursor-not-allowed'
                                }`}
